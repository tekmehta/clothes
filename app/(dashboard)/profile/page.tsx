...
const Profile = () => {
  ...
  <div className="min-h-screen bg-gradient-to-r from-gray-100 to-gray-200 flex items-center justify-center p-4 sm:p-8">
    <div className="max-w-4xl w-full p-7 bg-white rounded-lg shadow-lg">
          ...
          <thead className="bg-blue-600 text-white rounded-t-lg">
            <tr>
              <th className="px-4 py-2 text-center text-lg font-medium">
                <Link href="/component/orders" className="hover:underline hover:text-yellow-400 transition">Your Orders</Link>
              </th>
              <th className="px-4 py-2 text-center text-lg font-medium">
                <Link href="/component/wishlist" className="hover:underline hover:text-yellow-400 transition">Wishlist</Link>
              </th>
              <th className="px-4 py-2 text-center text-lg font-medium">
                <Link href="/component/cart" className="hover:underline hover:text-yellow-400 transition">Cart</Link>
              </th>
              <th className="px-4 py-2 text-center text-lg font-medium">
                <Link href="/allcontent/about" className="hover:underline hover:text-yellow-400 transition">Supports</Link>
              </th>
            </tr>
          </thead>
        </table>
      ...
      {/* Profile Header */}
      <div className="text-center mb-8 bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100 p-6 rounded-lg shadow-md">
        <img
